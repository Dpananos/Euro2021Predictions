...
model_data = list(
  nteams=nteams, ngames=ngames, team1=team1, team2=team2, score1=score1, score2=score2, df=df
)
```
...
no_prior_model = cmdstan_model('models/euro_model.stan')
fit = no_prior_model$sample(model_data, parallel_chains=4, seed=19920908)
